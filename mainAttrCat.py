...
from modelAttrCat import Model
...
with open(os.path.join(args.dataset + '_' + args.train_dir, 'args_l2_0.01.txt'), 'w') as f:
...
f = open(os.path.join(args.dataset + '_' + args.train_dir, 'log_l2_0.01.txt'), 'w')
